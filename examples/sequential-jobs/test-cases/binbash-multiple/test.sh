...
if [ -z "$1" ]
then
. submit_jobs.sh test-binbash.yaml ${RUN_TIME} ${NUM_RUN}
. submit_jobs.sh test-binbash-2.yaml ${RUN_TIME} ${NUM_RUN}
. submit_jobs.sh test-binbash-3.yaml ${RUN_TIME} ${NUM_RUN}
. submit_jobs.sh test-binbash-4.yaml ${RUN_TIME} ${NUM_RUN}
. submit_jobs.sh test-binbash-5.yaml ${RUN_TIME} ${NUM_RUN}
else
